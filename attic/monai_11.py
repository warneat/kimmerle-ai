'''this one takes exactly 3 series and 15 images. ignores other directories that have more or less images'''
...
def main():
    ...
    def filter_series(data, base_dir):
        ...
        for (study_id, series_id), group in grouped:
            ...
            if os.path.isdir(series_dir):
                ...
                if len(images) >= 15:
                    valid_series.append((study_id, series_id, group))
        return valid_series
    ...
    study_series_count = {}
    selected_series = []
    for study_id, series_id, group in filtered_series:
    ...
    valid_series_df = valid_series_df.groupby(
        ['study_id', 'series_id']).head(15)
